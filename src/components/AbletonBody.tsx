...
//Components
import { useAnimatedInView, useAnimatedTextInView } from './anim.tsx';
//Bootstrap
...
const AbletonBody: FC = () => {
    ...
    const animTextOne = useAnimatedTextInView(-500);
    const animTwo = useAnimatedInView();
    const animTextTwo = useAnimatedTextInView(500);
    const animThree = useAnimatedInView();
    const animTextThree = useAnimatedTextInView(-500);
    const animFour = useAnimatedInView();
    const animTextFour = useAnimatedTextInView(500);
    const animFive = useAnimatedInView();
    const animTextFive = useAnimatedTextInView(-500);
    const animSix = useAnimatedInView();
    const animTextSix = useAnimatedTextInView(500);
    const animSeven = useAnimatedInView();
    ...
    return (
        <Container fluid className='px-0 mx-0 d-flex flex-column align-items-center gap-5'>  
            ...
            <animated.div ref={animTextOne.ref} style={animTextOne.animation} className='container-fluid my-lg-5 cs-w-65'>
            ...
            <Container as={Row} fluid className='my-lg-5 py-5 cs-bg-gradient d-flex flex-row align-items-center justify-content-around px-0'>
                <animated.div ref={animTwo.ref} style={animTwo.animation} className='col-6 my-5 d-flex flex-column align-items-center'>
            ...
            <animated.div ref={animTextTwo.ref} style={animTextTwo.animation} className='container-fluid px-5 cs-w-65'>
            ...
            <animated.div ref={animThree.ref} style={animThree.animation} className='container-fluid px-5 my-lg-5 d-flex flex-column align-items-center'>
            ...
            <animated.div ref={animTextThree.ref} style={animTextThree.animation} className='container-fluid cs-w-65 my-lg-5'>
            ...
            <Container as={Row} fluid className='my-lg-5 py-5 cs-bg-gradient-two d-flex flex-row align-items-center justify-content-around px-0'>
                <Col xs={6} className='my-5 d-flex flex-column gap-5 align-items-center'>
                    <animated.div ref={animFour.ref} style={animFour.animation} className='d-flex flex-row justify-content-center'>
                ...
                <animated.div ref={animFour.ref} style={animFour.animation} xs={6} className='col-6 my-5 d-flex flex-column align-items-center'>
                    <Image fluid src={FifImg} alt='image' className='w-75' />
                </animated.div>
            </Container>
            <animated.div ref={animTextFour.ref} style={animTextFour.animation} className='container-fluid cs-w-65 my-lg-5'>
            ...
            <animated.div ref={animFive.ref} style={animFive.animation} className='container-fluid my-lg-5 px-5 d-flex flex-column align-items-center'>
                <Image fluid src={SevImg} alt='image' className='cs-w-85' />
            </animated.div>
            <animated.div ref={animTextFive.ref} style={animTextFive.animation} className='container-fluid cs-w-65 my-lg-5'>
            ...
            <Container as={Row} fluid className='my-lg-5 py-5 cs-bg-gradient-three d-flex flex-row align-items-center justify-content-around px-0'>
                <animated.div ref={animSix.ref} style={animSix.animation} className='col-6 my-5 d-flex flex-column gap-5 align-items-center'>
                    <Image fluid src={NinImg} alt='image' className='w-75' />
                </animated.div>
                <animated.div ref={animSix.ref} style={animSix.animation} className='col-6 my-5 d-flex flex-column align-items-end px-0'>
                    <Image fluid src={EigImg} alt='image' className='cs-w-80' />
                </animated.div>
            </Container>
            <animated.div ref={animTextSix.ref} style={animTextSix.animation} className='container-fluid cs-w-65 my-lg-5'>
            ...
            <animated.div ref={animSeven.ref} style={animSeven.animation} className='container-fluid my-lg-5 py-5 d-flex flex-row align-items-center justify-content-around px-0'>
